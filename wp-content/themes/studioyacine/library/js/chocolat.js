...
(function () {
  ...
  var Chocolat = /*#__PURE__*/ (function () {
    function Chocolat(elements, settings) {
      ...
      if (
        _instanceof(this.settings.container, Element) ||
        _instanceof(this.settings.container, HTMLElement)
      ) {
        ...
        value: function load(index) {
          ...
          return loadImage(this.images[index])
            ...
            .then(function () {
              ...
              _this2.elems.description.textContent = _this2.settings.description.call(
                _this2
              );
              _this2.elems.pagination.textContent = _this2.settings.pagination.call(
                _this2
              );
